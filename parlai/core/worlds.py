...
#
#     def parley_demo(self, input_text):
#         """
#         Agent 0 goes first.
#
#         Alternate between the two agents.
...
#         # acts[0] = agents[0].act()
#         input_text = 'hi'
#         acts[0] = {'id': 'localHuman', 'episode_done': False, 'label_candidates': None, 'text': str(input_text)}
#         # acts[0] = {'id': 'localHuman', 'episode_done': False, 'label_candidates': None, 'text': 'hi'}
#         agents[1].observe(validate(acts[0]))
#         # print(acts[0]) # {'id': 'localHuman', 'episode_done': False, 'label_candidates': None, 'text': 'hi'}
#         acts[1] = agents[1].act()
#         agents[0].observe(validate(acts[1]))
#         # print(acts[1]) # {'id': 'Seq2Seq', 'episode_done': False, 'text': 'how are you ?'}
#         self.update_counters()
#         result = acts[1]['text']
#
#         return result
...
#         script_response = open(script_out_path + '/' + file_name + '_' + model_name.split(':')[-1] + '_' + timestr +
#                                '.txt', 'w')
#
#         acts = self.acts
#         agents = self.agents
